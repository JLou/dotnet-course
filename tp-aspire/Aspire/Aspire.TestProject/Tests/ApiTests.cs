...
using Aspire.TestProject.Data;
using Aspire.TestProject.Models;

namespace Aspire.TestProject.Tests;
...
public class ApiTests(HttpClientDataClass httpClientData)
{
    ...
    public async Task GetWeatherForecastReturnsCorrectData(
        [Matrix("Freezing", "Bracing", "Chilly", "Cool", "Mild", "Warm", "Balmy", "Hot", "Sweltering", "Scorching")]
        string summary
    )
    {
        // Arrange
        ...
        var data = JsonSerializer.Deserialize<IEnumerable<WeatherForecast>>(content,
